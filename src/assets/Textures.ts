...
function makeGameTextures(): GameTexSet {
  ...
  const grass = mk('/textures/grass-albedo.png', 2.5);
  const rock = mk('/textures/rock-albedo.png', 1.5);
  const crystal = mk('/textures/crystal-facet.png', 1);
  const cloth = mk('/textures/cloth-albedo.png', 1);
  const armor = mk('/textures/armor-albedo.png', 1);
  const sky = mk('/textures/sky-panorama.png', 1);
  const suit = mk('/textures/suit-albedo.png', 2);
  const cape = mk('/textures/cape-albedo.png', 1.5);
  const helmet = mk('/textures/helmet-albedo.png', 1.2);
